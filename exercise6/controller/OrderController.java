...
public class OrderController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (HomeController.wlamp.getProductStatus()) {
            ...
            amount2.setText(Double.toString(HomeController.wlamp.getProductPrice() * HomeController.wlamp.getProductQuantity()));  
        ...
        if (HomeController.clamp.getProductStatus()) {
            ...
            amount3.setText(Double.toString(HomeController.clamp.getProductPrice() * HomeController.clamp.getProductQuantity()));
